...
<script src="https://unpkg.com/leaflet@1.6.0/dist/leaflet.js"></script>
  <script>
      function initMap() {
          var map = L.map('mapid').setView([51.505, -0.09], 13); // Replace with your default coordinates
          ...
          var nearbyLocations = [
              { lat: 51.5074, lon: -0.1278, popup: "Location 1" },
              { lat: 51.5033, lon: -0.1195, popup: "Location 2" },
      ...
      window.onload = function () {
          initMap(); // Initialize the map when the window loads
      };
  </script>
